...
issue](https://github.com/cisagov/cool-cdm-cloudtrail-tf-module/issues) in this
...
request](https://github.com/cisagov/cool-cdm-cloudtrail-tf-module/pulls), you
...
```console
cd cool-cdm-cloudtrail-tf-module
pyenv virtualenv <python_version_to_use> cool-cdm-cloudtrail-tf-module
pyenv local cool-cdm-cloudtrail-tf-module
